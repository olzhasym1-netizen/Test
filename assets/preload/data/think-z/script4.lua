...
idleoffsets = {'-10', '0'} -- I recommend you have your idle offset at 0
leftoffsets = {'-17', '0'}
downoffsets = {'-24', '-20'}
upoffsets = {'-28', '20'}
rightoffsets = {'-38', '2'}
...
function onBeatHit() -- character bop

     if curBeat % 2 == 1 then -- write whatever here its a note
        objectPlayAnimation('ThinkA','idle',false)
    end
end
...
idle_xml_name = 'ThinkA Idle0'
left_xml_name = 'ThinkA Left0'
down_xml_name = 'ThinkA Down0'
up_xml_name = 'ThinkA Up0'
right_xml_name = 'ThinkA Right0'
BPS_xml_name = 'welcome'
...
name_of_character_xml = 'ThinkA'
name_of_character = 'ThinkA'
name_of_notetype = 'ThinkA'
...
function onCreate()
	makeAnimatedLuaSprite(name_of_character, 'characters/' .. name_of_character_xml, getProperty('dad.x') + 100, y_position);
	...
	addAnimationByPrefix(name_of_character, 'BPS', BPS_xml_name, 24, false);
...
function onBeatHit()
	...
	if curBeat == 118 then
		objectPlayAnimation(name_of_character, 'BPS', false);
	end
	
	function onUpdate()
		if curBeat > 116 and curBeat < 127 then
