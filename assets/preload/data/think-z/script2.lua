...
function onBeatHit() -- character bop
     ...
     if curBeat % 2 == 1 then -- write whatever here its a note
        objectPlayAnimation('ThinkA2','idle',false)
    end
end
...
idle_xml_name = 'ThinkA2 Idle0'
left_xml_name = 'ThinkA2 Left0'
down_xml_name = 'ThinkA2 Down0'
up_xml_name = 'ThinkA2 Up0'
right_xml_name = 'ThinkA2 Right0'
...
name_of_character_xml = 'ThinkA2'
name_of_character = 'ThinkA2'
