...
function onBeatHit() -- character bop
     ...
     if curBeat % 2 == 1 then -- write whatever here its a note
        objectPlayAnimation('ThinkApov','idle',false)
    end
end
...
idle_xml_name = 'ThinkApov Idle0'
left_xml_name = 'ThinkApov Left0'
down_xml_name = 'ThinkApov Down0'
up_xml_name = 'ThinkApov Up0'
right_xml_name = 'ThinkApov Right0'
...
name_of_character_xml = 'ThinkApov'
name_of_character = 'ThinkApov'
