...
function onBeatHit() -- character bop
     ...
     if curBeat % 2 == 1 then -- write whatever here its a note
        objectPlayAnimation('ThinkJpov','idle',false)
    end
end
...
idle_xml_name = 'ThinkJpov Idle0'
left_xml_name = 'ThinkJpov Left0'
down_xml_name = 'ThinkJpov Down0'
up_xml_name = 'ThinkJpov Up0'
right_xml_name = 'ThinkJpov Right0'
...
name_of_character_xml = 'ThinkJpov'
name_of_character = 'ThinkJpov'
