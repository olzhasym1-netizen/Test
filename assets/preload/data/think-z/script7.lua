...
function onBeatHit() -- character bop
     ...
     if curBeat % 2 == 1 then -- write whatever here its a note
        objectPlayAnimation('ThinkJ','idle',false)
    end
end
...
idle_xml_name = 'ThinkJ Idle0'
left_xml_name = 'ThinkJ Left0'
down_xml_name = 'ThinkJ Down0'
up_xml_name = 'ThinkJ Up0'
right_xml_name = 'ThinkJ Right0'
...
name_of_character_xml = 'ThinkJ'
name_of_character = 'ThinkJ'
name_of_notetype = 'ThinkJ'
...
function onCreate()
	makeAnimatedLuaSprite(name_of_character, 'characters/' .. name_of_character_xml, getProperty('boyfriend.x'), y_position);
