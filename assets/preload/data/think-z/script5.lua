...
function onBeatHit() -- character bop
     ...
     if curBeat % 2 == 1 then -- write whatever here its a note
        objectPlayAnimation('ThinkJalt','idle',false)
    end
end
...
idle_xml_name = 'ThinkJalt Idle0'
left_xml_name = 'ThinkJalt Left0'
down_xml_name = 'ThinkJalt Down0'
up_xml_name = 'ThinkJalt Up0'
right_xml_name = 'ThinkJalt Right0'
...
name_of_character_xml = 'ThinkJalt'
name_of_character = 'ThinkJalt'
